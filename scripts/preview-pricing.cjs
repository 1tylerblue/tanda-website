...
http.createServer(async(req,res)=>{
  ...
  if(url.pathname.startsWith('/api/')) {
    ...
    return res.end(JSON.stringify({preview:true,travelBand:'unverified',distanceKm:null,travelFeeIncGst:0,addressVerified:false,travelStatus:'requires address confirmation',entryCount:0}));
  }
