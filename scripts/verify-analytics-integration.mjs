...
assert.match(
  analyticsSource,
  /opt_out_useragent_filter:\s*config\.environment === 'test' \|\| config\.environment === 'development'/,
  'User-agent filtering may be disabled only for labelled test and development environments',
);
