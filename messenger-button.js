  ...
  function messengerIcon() {
    return `
      <svg class="tanda-messenger-contact__icon" viewBox="0 0 32 32" aria-hidden="true" focusable="false">
        <path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M16 2.9C8.5 2.9 2.8 8.3 2.8 15.6c0 4 1.8 7.5 4.6 9.8v4.1c0 .7.8 1.1 1.4.7l3.6-2c1.1.3 2.3.4 3.6.4 7.5 0 13.2-5.4 13.2-12.7S23.5 2.9 16 2.9Zm-7.2 16.7 4.2-6.6c.5-.8 1.6-1 2.4-.4l3.1 2.3c.3.2.8.2 1.1-.1l3.8-3.7-4.2 6.6c-.5.8-1.6 1-2.4.4l-3.1-2.3c-.3-.2-.8-.2-1.1.1l-3.8 3.7Z"/>
      </svg>
    `;
  }
